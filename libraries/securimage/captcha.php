...
class Securimage {
  ...
  function saveData()
  {
     $_SESSION['securimage_code_value_login'] = strtolower($this->code);
  }
  ...
  function validate()
  {
    if ( isset($_SESSION['securimage_code_value_login']) && !empty($_SESSION['securimage_code_value_login']) ) {
      if ( $_SESSION['securimage_code_value_login'] == strtolower(trim($this->code_entered)) ) {
        $this->correct_code = true;
        $_SESSION['securimage_code_value_login'] = '';
      } else {
  ...
  {
    if (isset($_SESSION['securimage_code_value_login']) && !empty($_SESSION['securimage_code_value_login'])) {
      return $_SESSION['securimage_code_value_login'];
    } else {
      return '';
    }
  }
...
session_start();
$img = new securimage();
//$_SESSION['securimage_code_value_login'] = $img->code;
