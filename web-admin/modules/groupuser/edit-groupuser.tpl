...
<input type="hidden" id="id" name="id" value="{$data.id}" />
  <fieldset class="well">
  <p class="f_legend">Edit Group User</p>
  <div class="row-fluid">
    <div class="span6">
      ...
      <div class="control-group">
        <div class="controls">
          ...
          <button type="button" class="btn" onclick="ajaxpage('{$baseurl}/groupuser', 'Data Group User')" title="View Data"><i class="splashy-view_list"></i></button>
