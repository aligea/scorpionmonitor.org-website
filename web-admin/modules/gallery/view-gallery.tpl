<div class="row-fluid">
    <div class="span12">
        <h3 class="heading">DATA GALERI <img src="{$baseurl}/assets/img/loader.gif" id="loader" style="display:" /></h3>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span6" align="right">
                        <select name="pilihfilter" class="span3" id="pilihfilter">
                            ...
                            <option value="A.name">Judul</option>
...
function hapusdata(id) {
	...
	$.ajax({
	  type : 'POST',
	  url : '{$baseurl}/gallery/query-delete',
	  data : {
	    'id' : id
	  },
	  beforeSend : function(){
...
function tambahdata() {
	ajaxpage('{$baseurl}/gallery/add', 'Add Gallery');
}

function editdata(id) {
	ajaxpage('{$baseurl}/gallery/edit/'+id, 'Edit Gallery');
}
