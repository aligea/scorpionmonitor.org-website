<?php
//-- router
$app->get('/product', 'getview');
$app->post('/product', 'postview');

$app->get('/product/add', 'getadd');
$app->post('/product/add', 'postadd');

$app->get('/product/edit/:id', 'getedit');
$app->post('/product/edit/:id', 'postedit');

$app->post('/product/data', 'fetchdata');
$app->post('/product/validate', 'validate');
$app->post('/product/query-insert', 'insertdata');
$app->post('/product/query-update', 'updatedata');
$app->post('/product/query-delete', 'deletedata');
