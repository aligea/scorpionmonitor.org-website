  ...
  <div class="row-fluid">
    <div class="span6">
        <div class="control-group">
          ...
          <div class="controls">
            ...
            {foreach from=$datagrupuser item=data}  
              <option value="{$data.grupuser}">{$data.grupuser}</option>
            {/foreach}
            </select>
          </div>
        </div>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input type="password" id="password2" name="password2" class="validate[required, equals[password]]" />
          </div>
        </div>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input type="text" id="telp" name="telp" class="validate[]" />
          </div>
        </div>
