<form class="form-horizontal" id="inputform" name="inputform" method="post" action="{$baseurl}/moduleitem/validate">
  <fieldset class="well">
  <p class="f_legend">Add Modulte Item</p>
  <div class="row-fluid">
    <div class="span6">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="module" id="module" placeholder="" class="validate[required]" />
        </div>
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="menu" id="menu" placeholder="" class="validate[required]" />
        </div>
      </div>
      <div class="control-group">
    ...
    <div class="span6">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="urut" id="urut" placeholder="" class="validate[required] angka" />
        </div>
      </div>
