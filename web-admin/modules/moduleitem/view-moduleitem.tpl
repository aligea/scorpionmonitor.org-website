<div class="row-fluid">
    <div class="span12">
        <h3 class="heading">MODULE ITEMS <img src="{$baseurl}/assets/img/loader.gif" id="loader" style="display:" /></h3>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span6" align="right">
                        <select name="pilihfilter" class="span3" id="pilihfilter">
                            ...
                            <option value="A.menu">Nama menu</option>
                        </select>
		...
		success : function(r) {	
			...
			if (json.databody != null) {
				$.each(json.databody, function(m, item) {
					...
					field += '<td>'+item.groupmenu+'</td>';
					field += '<td>'+item.menu+'</td>';
...
function hapusdata(id) {
	...
	$.ajax({
	  type : 'POST',
	  url : '{$baseurl}/moduleitem/query-delete',
	  data : {
	    'id' : id
	  },
	  beforeSend : function(){
...
function tambahdata() {
	ajaxpage('{$baseurl}/moduleitem/add', 'Add Module Item');
}

function editdata(id) {
	ajaxpage('{$baseurl}/moduleitem/edit/'+id, 'Edit Module Item');
}
