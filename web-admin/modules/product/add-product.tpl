  ...
  <div class="row-fluid">
	...
	<div class="tab-content">
      ...
      <div class="row-fluid">
        ...
        <div class="span6">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" name="disc" id="disc" placeholder="" class="validate[min[0], max[100]] angka" value="0" />
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" name="qty" id="qty" placeholder="" class="validate[] angka" value="10" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row-fluid">
        ...
        <textarea name="description" id="description" cols="30" rows="3" class="summernote"></textarea>
      </div>
        ...
        <div class="span6">
          ...
          <table class="table table-hover table-condensed ">
            ...
            <!--
              <tr id="row_1">
                <td>
                  <a class="cbox_single cboxElement" title="http://localhost:800/izystore/images/Desert.jpg" href="http://localhost:800/izystore/images/Desert.jpg">http://localhost:800/izystore/images/Desert.jpg</a>
                  <input type="hidden" name="imgadd[1]" id="imgadd_1" value="http://localhost:800/izystore/images/Desert.jpg" />
                </td>
                <td><a href="javascript:hapusGambar('1');" title="Hapus gambar ini"><i class="icon icon-remove"></i></a></td>
              </tr>
            -->
            </tbody>
          </table>
      ...
      <div class="row-fluid">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            ...
            {foreach from=$dataatribut item=attr}  
              <option value="{ucfirst($attr)}">{$attr}</option>
            {/foreach}
            </select>
          </div>
        </div>
        <div class="control-group">
          ...
          <div class="controls">
            <textarea name="atribut_data" id="atribut_data"></textarea>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <textarea name="atribut2_data" id="atribut2_data"></textarea>
            <span class="help-block">Gunakan tanda ' ; ' (titik koma) sebagai pemisah </span>
          </div>
        </div>
...
function submitForm(formElm){
  ...
  $.ajax({
    url : '{$baseurl}/product/query-insert',	
    type:'POST',
