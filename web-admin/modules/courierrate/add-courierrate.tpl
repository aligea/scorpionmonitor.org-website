<form class="form-horizontal" id="inputform" name="inputform" method="post" action="{$baseurl}/courierrate/validate">
  <fieldset class="well">
  <p class="f_legend">Add Courier Rate</p>
  <div class="row-fluid">
    <div class="span6">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="provinsi" id="provinsi" placeholder="" class="validate[required]" />
        </div>
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="daerah" id="daerah" placeholder="" class="validate[required]" />
        </div>
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="hargaok" id="hargaok" placeholder="" class="validate[required] angka" />
        </div>
      </div>
...
function submitForm(formElm){
  ...
  $.ajax({
    url : '{$baseurl}/courierrate/query-insert',	
    type:'POST',
