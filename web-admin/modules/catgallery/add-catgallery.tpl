<form class="form-horizontal" id="inputform" name="inputform" method="post" action="{$baseurl}/catgallery/validate">
  <fieldset class="well">
  <p class="f_legend">Add Category Gallery</p>
  <div class="row-fluid">
    <div class="span6">
      ...
      <div class="control-group">
        <div class="controls">
          ...
          <button type="button" class="btn" onclick="ajaxpage('{$baseurl}/catgallery', 'Data Kategori Gallery')" title="View Data"><i class="splashy-view_list"></i></button>
    ...
    <div class="span6">
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" onchange="document.getElementById('view-images').src = this.value;" name="images" placeholder="url gambar" id="images" class="form-control validate[]">
          <a title="Browse Image" href="javascript:browseImage('images')" class="btn btn-small"><i class="splashy-image_cultured"></i></a>
          <img style="width:150px;height:120px;" class="img-responsive img-thumbnail thumbnail" id="view-images">
        </div>
      </div>
...
function submitForm(formElm){
  ...
  $.ajax({
    url : '{$baseurl}/catgallery/query-insert',	
    type:'POST',
