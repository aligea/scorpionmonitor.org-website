<div class="row-fluid">
    <div class="span12">
        <h3 class="heading">GALLERY CATEGORIES <img src="{$baseurl}/assets/img/loader.gif" id="loader" style="display:" /></h3>
...
function hapusdata(id) {
	...
	$.ajax({
	  type : 'POST',
	  url : '{$baseurl}/catgallery/query-delete',
	  data : {
	    'id' : id
	  },
	  beforeSend : function(){
...
function tambahdata() {
	ajaxpage('{$baseurl}/catgallery/add', 'Add Category Gallery');
}

function editdata(id) {
	ajaxpage('{$baseurl}/catgallery/edit/'+id, 'Edit Category Gallery');
}
