<form class="form-horizontal" id="inputform" name="inputform" method="post" action="{$baseurl}/customer/validate">
  <fieldset class="well">
  <p class="f_legend">Add Customer</p>
  <div class="row-fluid">
    <div class="span6">
      <div class="control-group">
        <label class="control-label" for="username">Username/Email</label>
        <div class="controls">
          <input type="text" name="username" id="username" placeholder="" class="validate[required, custom[email]]" />
        </div>
      </div>    
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="telpon" id="telpon" placeholder="" class="validate[]" />
        </div>
      </div>    
    ...
    <div class="span6">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="kota" id="kota" placeholder="" class="validate[required]" />
        </div>
      </div>    
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <textarea id="alamat" name="alamat" class="validate[required]"></textarea>
        </div>
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="kodepos" id="kodepos" placeholder="" class="validate[required]" />
        </div>
      </div>    
...
function submitForm(formElm){
  ...
  $.ajax({
    url : '{$baseurl}/customer/query-insert',	
    type:'POST',
