<div class="row-fluid">
    <div class="span12">
        <h3 class="heading">FAQ <img src="{$baseurl}/assets/img/loader.gif" id="loader" style="display:" /></h3>
...
function tambahdata() {
	ajaxpage('{$baseurl}/faq/add', 'Add FAQ');
}

function editdata(id) {
	ajaxpage('{$baseurl}/faq/edit/'+id, 'Edit FAQ');
}
