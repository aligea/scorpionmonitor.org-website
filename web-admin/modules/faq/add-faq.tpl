<form class="form-horizontal" id="inputform" name="inputform" method="post" action="javascript:void(0)">
  <fieldset class="well">
  <p class="f_legend">Add FAQ</p>
  <div class="row-fluid">
    <div class="span6">
      <strong>Tanya</strong>
      <div class="row-fluid">
        <textarea class="summernote" id="tanya" name="tanya"></textarea>      
      </div>    
    ...
    <div class="span6">
      <strong>Jawab</strong>
      <div class="row-fluid">
        <textarea class="summernote" id="jawab" name="jawab"></textarea>
      </div>    
